...
// CODE HERE
const evenNumbers = mixedNumbers.filter(nums => nums%2 === 0)
...
// CODE HERE
const postTaxPrices = prices.map(tax=>tax*1.07);
...
// CODE HERE
const myStrongest = (x) => monstersInYourPocket.filter(mons => mons.cp>x)
console.log(myStrongest(200))
console.log(`5`==5)
...
// CODE HERE
let orderTot = orders.map(array => array.price*(array.tax+1))
