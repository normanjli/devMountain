...
sayHelloButton.addEventListener(`mouseout`, defaultColor)
// PROBLEM 4
/*
...
const repeatMyParam = () => {
    axios.get(`http://localhost:3000/repeat/goose`)
    .then(res=> {
...
// CODE HERE
const labQ = () =>{
    axios.get(`http://localhost:3000/query-test/?a=d&g=f`)
    .then(res=>console.log(res.data))
    .catch(err=>console.log(err))
}
document.getElementById(`query-button`).addEventListener(`click`, labQ)
