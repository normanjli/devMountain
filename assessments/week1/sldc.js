...
*/
let planning = `determine what role the program needs to fill, what the needs are for the remainder of the development lifecycle, and how many resources to allocate for the program`
